...
$con = new dbh();
$fun = new Functions();
$result = $fun->SelectRechten2($_SESSION["hekkensluiterFunctie"]);
if ($result['actiebezoekers'] == 1) {
...
if(strtotime($mysql_timestamp) > strtotime("-15 minutes")) {
  ...
  header("Refresh:0; url=/Project07/pages/HekkensluiterApplicatie.php");
}
?>
<!DOCTYPE html>
<html>
...
if($check == 0) {
    ...
    if($check2 == 1) {
        ...
        header("Refresh:0; url=BezoekersPaneel.php");
    }
    else{
